...
<head>
    ...
    <style>
        /* Memastikan warna konsisten dengan variabel --lime */
        .org-title { color: var(--lime); }
        .org-meta { color: var(--lime); opacity: 0.8; }
        .org-desc { color: #ccc; }
    </style>
</head>
<body class="grid-bg">
    ...
    <div class="main-layout" style="margin-top: 40px;">
            ...
            <div style="border-left: 2px solid var(--border); padding-left: 20px; margin-left: 10px;">
                <?php foreach($pendidikan as $p): ?>
                    <div style="position: relative; margin-bottom: 25px;">
                        ...
                        <div style="font-weight: bold; font-size: 1.1rem; color: white;"><?= $p['institusi'] ?></div>
        ...
        <div class="panel">
            <h3 style="color: var(--lime); margin-top: 0;">👥 Keterlibatan Organisasi</h3>
            <?php foreach($organisasi as $o): ?>
                <div style="border-bottom: 1px solid var(--border); padding-bottom: 15px; margin-bottom: 15px;">
                    ...
                    <div style="font-size: 0.85rem; margin: 4px 0; color: var(--lime); font-family: monospace;"><?= $o['jabatan'] ?> (<?= $o['tahun'] ?>)</div>
                    <p style="font-size: 0.9rem; margin: 0; color: #ccc;"><?= $o['deskripsi'] ?></p>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
